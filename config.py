...
SHORTLINK_API = environ.get("SHORTLINK_API", "publicearn.com") # shortlink api
SHORTLINK_URL = environ.get("SHORTLINK_URL", "931f4b13bd82a38c75aa92face2613e5dad9bd4d") # shortlink domain without https://
