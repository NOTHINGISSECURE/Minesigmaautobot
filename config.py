...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://Minesigma:sQ63Z38047Rq7PI1@cluster0.kzzac.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
CDB_NAME = environ.get("CDB_NAME", "clonetehvj")
